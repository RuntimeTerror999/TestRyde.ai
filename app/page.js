...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col pt-20">
      ...
      <section className="relative py-16 md:py-28 bg-lime-100 ">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-500 mb-8 max-w-2xl mx-auto">
              Curated by AI,crafted for you - Discover your perfect ride with
              TestRyde.ai
            </p>
          </div>
      ...
      <section className="py-12 bg-blue-200">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Button variant="ghost" className="flex items-center border border-black" asChild>
              <Link href="/cars">
      ...
      <section className="py-12 bg-gray-100 ">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <Button variant="ghost" className="flex items- border border-black" asChild>
              <Link href="/cars">
                View All <ChevronRight className="ml-1 h-4 w-4" />
              </Link>
            </Button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {carMakes.map((make) => (
              <Link
                ...
                className="bg-white rounded-lg shadow p-4 text-center hover:shadow-md transition cursor-pointer border border-black"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {bodyTypes.map((type) => (
              ...
              >
                <div className="overflow-hidden rounded-lg flex justify-end h-28 mb-4 relative border border-black">
                  <Image
                    src={
      ...
      {/* CTA Section */}
      <section className="py-16 bg-blue-200 text-white">
